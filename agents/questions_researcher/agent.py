...
base_instructions = load_file("agents/questions_researcher/instructions.txt")  # Common research instructions
base_description = load_file("agents/questions_researcher/description.txt")    # Common agent description
